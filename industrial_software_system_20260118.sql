...
CREATE TABLE `file_meta` (
  ...
  `creator_id` int DEFAULT NULL COMMENT '创建者用户ID',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='存储证书生成信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `mod_tasks` VALUES (8,'TestDaBa',20,'2025-10-20 19:47:00',1,'后处理','通用后处理','未启动',NULL),(9,'TestXiaoBa',20,'2025-10-20 19:53:51',1,'求解器','冲击','未启动','GPU'),(10,'TestFuck',20,'2025-10-20 20:14:36',1,'前处理','多体','已结束',NULL);
...
INSERT INTO `mod_users` VALUES (20,'张三','$2a$10$dqG1yMAPgUfuhHcmGFnw3e9EjXBaaFN6bxeIypzf9dLZTkpUBta2i',0,'13726139710',0,0);
...
-- Dump completed on 2026-01-18 20:29:19
