...
public interface FileMetaMapper extends BaseMapper<FileMeta> {
     ...
     * @return 分页结果
     */
    IPage<FileMeta> selectPageByCreatorIdAndDbType(Page<FileMeta> page, @Param("creatorId") Integer creatorId, @Param("dbType") String dbType,@Param("keyword") String keyword);
